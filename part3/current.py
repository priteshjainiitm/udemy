# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 17:48:26 2017
...
def main():
    ...
    Ytrain = train['y'].flatten() - 1 #matlab indexes by 1
    Xtrian, Ytrain = shuffle(Xtrain, Ytrain)
    Ytrain_ind = y2indicator(Ytrain)
    
    Xtest = flatten(test['X'].astype(np.float32) /255)
    Ytest = test['y'].flatten() - 1 #matlab indexes by 1
