...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 11 15:23:25 2017
...
from util import init_weights, get_poetry_classifier_data
...
class SimpleRNN:
    ...
    def fit(self, X, Y, learning_rate=10e-1, mu=0.99, reg=1.0, activation=T.tanh, epochs=500, show_fig=False):
            ...
            for i in xrange(epochs):
                ...
                print "i:", i, "cost:", cost, "correct_rate:", (float(n_correct)/N)
